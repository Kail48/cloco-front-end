...
export default function DeleteUserDialog({ user,refreshList }) {
    ...
    <div className="w-full h-96 flex justify-center items-center">
      {success ? (
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-center md:text-xl">Do you want to delete user with the email {user.email}?</h1>
          <button
            onClick={() => {
              sendDeleteId(user.id);
            }}
