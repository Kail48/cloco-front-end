...
const pages={
  ...
  return (
    ...
    <Toaster/>
    <div className='flex justify-end py-6 pr-10 gap-x-2'>
    <button  onClick={open} className="py-2 px-2 bg-black text-white rounded-md hover:bg-gray-400 hover:text-black">Add New Artist</button>
    <FileDownloader/>
    <button  onClick={()=>{}} className="py-2 px-2 bg-black text-white rounded-md hover:bg-gray-400 hover:text-black">Import From Csv</button>
    </div>
