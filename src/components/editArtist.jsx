...
export default function EditArtist({artist,refreshList}) {
    ...
    const [firstReleaseYear,setFirstReleaseYear]=useState(artist.first_release_year)
    const [noOfAlbums,setNoOfAlbums]=useState(artist.number_of_albums_released)
    console.log(name)
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            >
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                  onChange={(e)=>{setNoOfAlbums(e.target.value)}}
                    id="no-of_albums"
